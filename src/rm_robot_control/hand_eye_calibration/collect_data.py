...
cam0_origin_path = "/home/hh/realman_robotic_arm/src/rm_robot_control/hand_eye_calibration/eye_hand_data/data03_crt"
os.makedirs(cam0_origin_path, exist_ok=True)
...
def send_cmd(client, cmd, get_pose=True):
    ...
    try:
        ...
        if arm_state.get("arm_err", 1) != 0 or arm_state.get("sys_err", 1) != 0:
            return False, f"机械臂报错: arm_err={arm_state.get('arm_err')}, sys_err={arm_state.get('sys_err')}"
