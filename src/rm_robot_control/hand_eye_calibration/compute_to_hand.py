...
from rm_robot_control.hand_eye_calibration.save_poses_to_hand import poses2_main
...
images_path = "/home/hh/RealmanRobotArm/src/rm_robot_control/hand_eye_calibration/eye_hand_data/data02"  # 替换成你的实际路径
file_path = os.path.join(images_path, "poses.txt")

with open("/home/hh/RealmanRobotArm/src/rm_robot_control/hand_eye_calibration/config.yaml", 'r', encoding='utf-8') as file:
